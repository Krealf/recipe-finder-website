...
import SimplicitySection from "@/components/organisms/SimplicitySection/index.jsx";
import ReadyToCookSection from "@/components/organisms/ReadyToCookSection/index.jsx";
    ...
    <>
      ...
      <section className={`l-section`}>
        <div className={`${styles.usability__inner} container`}>
          <h2 className={`${styles.usability__heading}`}>Why we exist</h2>
